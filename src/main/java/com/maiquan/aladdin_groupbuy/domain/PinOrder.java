package com.maiquan.aladdin_groupbuy.domain;

import java.io.Serializable;
import java.util.Date;

public class PinOrder implements Serializable{
	private static final long serialVersionUID = -5354307726169331413L;
    ...
    public void setPinUserID(Integer pinUserID) {
	...
	public String toString() {
		return "PinOrder [ID=" + ID + ", pinUserID=" + pinUserID + ", pinID="
				+ pinID + ", parentID=" + parentID + ", parentCode="
				+ parentCode + ", orderCode=" + orderCode + ", orderStatus="
				+ orderStatus + ", payStatus=" + payStatus + ", logistics="
				+ logistics + ", logisticsNum=" + logisticsNum
