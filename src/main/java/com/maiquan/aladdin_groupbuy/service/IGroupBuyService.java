package com.maiquan.aladdin_groupbuy.service;

import java.util.List;
import java.util.Map;

import com.maiquan.aladdin_groupbuy.domain.PinInfo;
import com.maiquan.aladdin_groupbuy.domain.PinOpen;
import com.maiquan.aladdin_groupbuy.domain.PinOrder;
import com.maiquan.aladdin_groupbuy.domain.PinOrderProduct;
...
public interface IGroupBuyService {
	 ...
	 * 提交拼团订单
	 */
	int placeOrder(String mqID, Integer pinUserID, Integer productID, Integer pinID, Integer skuID, Integer buyNum, Long pinPrice, Long postFee, String invoiceName, String notes, String requestID);
